-- Fix migrations - Run this if you get "already exists" errors
-- This script uses IF NOT EXISTS and CREATE OR REPLACE to avoid errors

-- Drop and recreate app_role type if exists
DO $$
BEGIN
