  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="container max-w-3xl pt-28 pb-20 space-y-8">
      ...
      <section className="space-y-4 text-foreground/80 leading-relaxed">
        ...
        <p>Your information is used to provide and maintain the DataFlow service, process transactions, send service-related communications, improve our platform, and comply with legal obligations. We never sell your personal data to third parties.</p>
        ...
        <p>You have the right to access, correct, or delete your personal information. You may also opt out of marketing communications at any time. To exercise these rights, contact us at privacy@dataflow.com.</p>
