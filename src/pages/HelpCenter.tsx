...
const topics = [
  ...
  { icon: MessageCircle, title: "API Documentation", desc: "Complete reference for the DataFlow REST API including authentication, endpoints, and code samples." },
  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="container max-w-4xl pt-28 pb-20 space-y-16">
      <div className="text-center">
        ...
        <p className="text-lg text-muted-foreground">Find answers, guides, and resources to get the most out of DataFlow.</p>
      </div>
