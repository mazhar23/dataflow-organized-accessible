  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="container max-w-3xl pt-28 pb-20 space-y-8">
      ...
      <section className="space-y-4 text-foreground/80 leading-relaxed">
        ...
        <p>By accessing or using DataFlow, you agree to be bound by these Terms of Service. If you do not agree, you may not use the platform. These terms apply to all users, including visitors, registered users, and paying customers.</p>
        ...
        <p>You agree not to use DataFlow for any unlawful purpose, to transmit malicious code, to interfere with platform operations, or to attempt to gain unauthorised access to other accounts or systems.</p>
        ...
        <p>DataFlow and its original content, features, and functionality are owned by DataFlow Inc. You retain ownership of all data you upload to the platform.</p>
        ...
        <p>DataFlow shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service. Our total liability is limited to the amount you paid in the 12 months preceding the claim.</p>
      </section>
    </main>
    <Footer />
  </div>
