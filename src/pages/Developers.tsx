...
const resources = [
  { icon: Terminal, title: "REST API", desc: "Full-featured RESTful API for programmatic access to all DataFlow functionality. Supports JSON request and response formats.", link: "/api-docs" },
  ...
  { icon: BookOpen, title: "Integration Guides", desc: "Step-by-step walkthroughs for connecting DataFlow to Salesforce, HubSpot, Zapier, and other popular platforms." },
  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="container max-w-4xl pt-28 pb-20 space-y-16">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground">Build powerful integrations with DataFlow using our APIs, SDKs, and developer tools.</p>
      </div>
