...
const features = [
  { icon: CloudUpload, title: "Bulk Data Import", desc: "Upload CSV, JSON, or Excel files and let Intulist automatically parse, validate, and organise your records in seconds." },
  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="container max-w-5xl pt-28 pb-20 space-y-16">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground">Intulist combines powerful ingestion, intelligent routing, and enterprise-grade security into one seamless platform.</p>
      </div>
